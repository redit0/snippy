...
tool_properties_save_snippets = [
    ...
    ToolProperty(_PROJECT_ID_PROPERTY_NAME, "string", "The ID of the project the snippet belonges to. Optional, defaults to 'default-project' if not provided."),
...
@app.embeddings_input(
    arg_name="embeddings", # Variable name for the embeddings input
    input="{arguments." + _SNIPPET_PROPERTY_NAME + "}", # Reference to the snippet content
    input_type="rawText", # Specify the input type
    embeddings_model="%EMBEDDING_MODEL_DEPLOYMENT_NAME%" # Model name for embedding generation
)
